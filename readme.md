...
| 구분 | 내용 |
|:---|:---|
| **스트리트뷰** | 네이버 로드뷰 파노라마 API, 강릉시 전 도로망 5m 간격, **36,367지점** |
...
<p align="center">
  <img src="result_sample/260818/sample_00_panorama.jpg" alt="수집된 360° 파노라마 원본" width="100%">
</p>

<sub>*(예시) 수집된 파노라마 원본. 왼쪽부터 좌·정면·우·후방이며, 오른쪽 두 구간(바닥·하늘)은 사용하지 않습니다.*</sub>
